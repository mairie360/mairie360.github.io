...
const composants = [
  {
    icon: Mail,
    title: 'Emails & messagerie interne',
    description: 'Centralisez tous vos échanges professionnels avec une boîte mail complète, des notifications intelligentes et un suivi des discussions par dossier.',
    features: [
  ...
  },
  {
    ...
    description: 'Communiquez rapidement avec vos collègues via des canaux par service, des messages directs et le partage instantané de fichiers.',
    features: [
  ...
  },
  {
    ...
    description: 'Suivez tous les projets de votre mairie (travaux, événements, dossiers citoyens) avec une gestion claire des tâches et des statuts.',
    features: [
  ...
  },
  {
    ...
    description: 'Gérez les agendas partagés, planifiez les réunions, réservez les salles et organisez les événements communaux en toute simplicité.',
    features: [
  ...
  },
  {
    ...
    description: 'Stockage centralisé et sécurisé de tous vos documents avec gestion des droits d\'accès, recherche avancée et versioning.',
    features: [
  ...
  },
  {
    ...
    description: 'Formez vos agents en continu avec des modules de formation adaptés, des parcours personnalisés et un suivi détaillé des compétences.',
    features: [
