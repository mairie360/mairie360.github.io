...
const cibles = [
  {
    ...
    description: 'Adaptée aux mairies de toutes tailles, de 500 à 20 000 habitants, avec des modules évolutifs selon vos besoins.',
  },
  {
    icon: TrendingUp,
    title: 'Collectivités en transition numérique',
    description: 'Pour les mairies qui souhaitent moderniser leurs outils et passer au cloud sans bouleverser leur organisation.',
  },
  {
    icon: Users,
    title: 'Équipes recherchant la collaboration',
    description: 'Destiné aux services municipaux qui veulent améliorer leur communication interne et leur efficacité collective.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#3F3F3F]/70 max-w-3xl mx-auto">
            MAIRIE360 a été conçu pour répondre aux besoins spécifiques des collectivités
            territoriales françaises, quelle que soit leur taille.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center md:text-left">
              <div>
                ...
                <p className="text-white/90 text-sm">
                  Commencez avec les modules essentiels et ajoutez-en au fur et à mesure
                  de l'évolution de vos besoins.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2 text-lg">Flexibilité</h4>
                <p className="text-white/90 text-sm">
                  Chaque commune est unique, MAIRIE360 s'adapte à votre organisation
                  et à vos processus existants.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2 text-lg">Accessibilité</h4>
                <p className="text-white/90 text-sm">
                  Des tarifs adaptés aux budgets des collectivités publiques,
              ...
              <div>
                ...
                <p className="text-white/90 text-sm">
                  Une équipe francophone qui comprend les spécificités de l'administration
                  française et ses contraintes.
                </p>
              </div>
            </div>
          </div>
